...
rm -rf praw*gz websocket_client*gz iterators*gz
...
wget "https://files.pythonhosted.org/packages/80/4d/e874bbb8ae7380d7ff4c7d6ff1925956cebf1495d8594866d36f189aa88d/iterators-0.0.2.tar.gz"
...
tar -xzf iterators-0.0.2.tar.gz iterators-0.0.2/iterators
rm -rf iterators
mv iterators-0.0.2/iterators .
rm -rf iterators-0.0.2
